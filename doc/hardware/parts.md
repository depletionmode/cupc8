...
| HDMI +5V buck-boost | TPS63802DLAR (VSON-10), 0.47 µH FXL0420-R47-M (C167200, 14 mΩ, Isat 9.5 A), 300k (C23024) / 33k (C4216) 1 %, basic | C2845237 | 18,125 | 2 | GPU: the pin at 5.045 V (HDMI: 4.8–5.3 V) whether the card's +5V is above or below it (POW-008); replaces the B5819W Schottky |
