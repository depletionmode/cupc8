...
| Panel | Designed for the **Good Display GDEY0583T81, 5.83", 648 x 480** (the build `eink.elf`); the 7.5" GDEY075T7 or Waveshare 7.5" V2, 800 x 480, work with `eink750.elf`. All have the UltraChip **UC8179** controller. **M1's panel (David, 2026-09-26): the Waveshare 7.5" e-Paper HAT (V2)**, 800 x 480, with its e-Paper Driver HAT Rev2.3 and 9-pin cable: it plugs straight into J2 and runs `eink750.elf` unchanged, with fast, partial and 4-grey refreshes (buy stock sold after September 2023). The Waveshare 5.83" HAT was considered and set aside: its glass does full refreshes only, with 2 greys (Buying the panel, below) |
