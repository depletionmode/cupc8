...
# Board: a 56 x 48 mm body above the x4 card-edge tab (mm, y down). The
# edge footprint draws the tab's own Edge.Cuts; it meets the body at its
# (-0.65, -4.95) and (33.65, -4.95), so at y = 48 with the tab centred. The
# 10 mm band above the parts is for the 50-odd slot nets fanning out of the tab.
W, H = 56, 48
