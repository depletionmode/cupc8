...
//
//   node test/emu/test_e2e.mjs [E2E-002|E2E-003|E2E-004|E2E-007|E2E-008|E2E-010] [--record]
//
...
async function e2e010() {
  log('E2E-010: net config, net lookup, net get NAME, net ping on the real Wi-Fi firmware');
...
const tests = { 'E2E-002': e2e002, 'E2E-003': e2e003, 'E2E-007': e2e007, 'E2E-008': e2e008, 'E2E-010': e2e010 };
log(`backend: ${backend === 'native' ? 'native (emu/machine)' : 'machine.mjs'}`);
for (const [id, fn] of Object.entries(tests)) if (only ? only === id : !['E2E-007', 'E2E-008', 'E2E-010'].includes(id) || backend === 'native') await fn();
